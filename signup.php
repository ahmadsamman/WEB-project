...
<div class="container">
      ...
      <div  class="form">
        <form id="contactform" method="POST"> 
          ...
          <input id="name" name="name" placeholder="" required="" tabindex="1" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['name']; } ?>"> 
           
          <p class="contact"><label for="email">Email</label></p> 
          <input id="email" name="email" placeholder="example@gmail.com" required="" type="email" value="<?php if(isset($_POST['signup'])) { echo $_POST['email']; } ?>"> 
                
                <p class="contact"><label for="username">Username</label></p> 
          <input id="username" name="username" placeholder="" required="" tabindex="2" type="text" value="<?php if(isset($_POST['signup'])) { echo $_POST['username']; } ?>"> 
          ...
          <input type="password" id="repassword" name="repassword" required=""> 
            ...
            <option value="Computer Science">School of Computing</option>
            <option value="Electrical">School of Electrical Engineering</option>
            <option value="Mechanical">School of Mechanical Engineering</option>
            </select><br><br>
